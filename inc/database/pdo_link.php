	...
	if ($params) {
		...
		for ($i = 0; $i < count($params); $i++) {
			...
			switch(gettype($param)) {
				case 'boolean': $statement->bindValue($i + 1, $param, PDO::PARAM_BOOL); break;
				case 'integer': $statement->bindValue($i + 1, $param, PDO::PARAM_INT); break;
				case 'double': $statement->bindValue($i + 1, $param, PDO::PARAM_DOUBLE); break;
				default: $statement->bindValue($i + 1, $param, PDO::PARAM_STR); break;
			}
		}
		$statement->execute();
	} else {
