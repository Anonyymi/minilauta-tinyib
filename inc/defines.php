...
// Minilauta constants
define('TINYIB_PAGETYPE_BOARD', '0');
define('TINYIB_PAGETYPE_CATALOG', '1');
define('TINYIB_PAGETYPE_THREAD', '2');
define('TINYIB_PAGETYPE_MANAGE', '3');

// Minilauta settings
if (!isset($minilauta_categories)) {
	$minilauta_categories = array();
}
if (!defined('TINYIB_ANONFILE')) {
	define('TINYIB_ANONFILE', false);
}
if (!defined('TINYIB_DUPLICATES')) {
	define('TINYIB_DUPLICATES', 0);
}
if (!defined('TINYIB_OVERBOARD')) {
	define('TINYIB_OVERBOARD', false);
}
if (!defined('TINYIB_GEOIP')) {
	define('TINYIB_GEOIP', false);
}
