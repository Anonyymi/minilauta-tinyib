...
define('TINYIB_ANONFILE', false); // Allow users to anonymize file names
define('TINYIB_DUPLICATES', 0); // Number of max duplicate files allowed
define('TINYIB_OVERBOARD', false); // Make this board an overboard, showing posts from all boards
define('TINYIB_GEOIP', false); // Check poster IP against GeoIP db, add country flag to post
